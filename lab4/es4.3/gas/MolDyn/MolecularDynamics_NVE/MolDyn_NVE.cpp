...
void Average(int index){
	...
	if (index == 0){
		...
		for(int i=0; i<nblocks; i++){
			Epot_ave << x[i] << " " << setprecision(cifre) << sum_prog[i] << " " << setprecision(cifre) << err_prog[i] << endl;
		}
		Epot_ave.close();
	}
	...
	if (index == 1){
		...
		for(int i=0; i<nblocks; i++){
			Ekin_ave << x[i] << " " << setprecision(cifre) << sum_prog[i] << " " << setprecision(cifre) << err_prog[i] << endl;
		}
		Ekin_ave.close();
	}
	...
	if (index == 2){
		...
		for(int i=0; i<nblocks; i++){
			Etot_ave << x[i] << " " << setprecision(cifre) << sum_prog[i] << " " << setprecision(cifre) << err_prog[i] << endl;
		}
		Etot_ave.close();
	}
	...
	if (index == 3){
		...
		for(int i=0; i<nblocks; i++){
			Temp_ave << x[i] << " " << setprecision(cifre) << sum_prog[i] << " " << setprecision(cifre) << err_prog[i] << endl;
		}
		Temp_ave.close();
	}
